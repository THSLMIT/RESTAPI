<?php
/**
* Hermes Framework :: Database Class (CORE Class)
* @name HERMES FRAMEWORK - DATABASE CLASS
* @version Alpha
* @author Yuya Ong (Tigy Tech Studio)
* @category Hermes Core Classes
*/

/* Sample usage of methods are included in the reference subfolders within this directory. */
